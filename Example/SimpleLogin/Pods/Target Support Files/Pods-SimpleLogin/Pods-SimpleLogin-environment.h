...
// CleverSDK
#define COCOAPODS_POD_AVAILABLE_CleverSDK
#define COCOAPODS_VERSION_MAJOR_CleverSDK 0
#define COCOAPODS_VERSION_MINOR_CleverSDK 0
#define COCOAPODS_VERSION_PATCH_CleverSDK 1
