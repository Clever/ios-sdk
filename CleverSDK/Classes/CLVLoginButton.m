...
const CGFloat CLVLoginButtonBaseWidth = 240.0;
const CGFloat CLVLoginButtonBaseHeight = 52.0;
...
+ (UIImage *)textForButton:(CGSize)size {
    ...
    CGFloat moveX = ((size.width - CLVLoginButtonBaseWidth) / 2) + 20;
    CGFloat moveY = 12;
